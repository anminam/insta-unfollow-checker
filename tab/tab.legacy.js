...
// Storage imports (migrated from monolithic storage.js to domain modules)
import { getWhitelist, saveWhitelist, toggleWhitelist } from './storage/whitelist.js';
import { getMemos, getUserMemo, setUserMemo } from './storage/memo.js';
import { getUnfollowHistory, recordUnfollow, removeUnfollowRecord } from './storage/history.js';
