...
export const I18N = {
  ko: {
    ...
    viewProfile: '프로필',
    protect: '보호',
    protectedUser: (u) => `@${u} 보호됨`,
    unprotectedUser: (u) => `@${u} 보호 해제`,
    renamedFollowers: (n) => `아이디 변경 (${n})`,
    whitelist: '보호',
    ...
    // v5.0: Batch Tag
    batchTag: '일괄 태그',
    batchTagTitle: '일괄 태그 적용',
    batchTagApply: '적용',
    batchTagDone: (n, tag) => `${n}명에게 "${tag}" 태그 적용 완료`,
    // v5.0: Insights
    insightsTitle: '주목할 변화',
    insightMassUnfollow: (n) => `대량 언팔 감지: ${n}명이 팔로우 취소`,
    insightMassFollow: (n) => `새 팔로워 급증: ${n}명 유입`,
    insightNetGrowth: (n) => `순 성장: ${n > 0 ? '+' : ''}${n}명`,
    insightChurnHigh: '이탈률이 높습니다. 콘텐츠 점검을 권장합니다.',
    insightGrowthGood: '팔로워가 꾸준히 증가하고 있습니다!',
    insightNoChange: '최근 변동이 없습니다.',
    weeklyTrend: '주간 트렌드',
    // v5.0: Smart Unfollow
    smartUnfollowTitle: '추천 언팔로우',
    smartUnfollowBtn: '추천 언팔',
    smartUnfollowEmpty: '추천 대상이 없습니다.',
    smartGhost: '고스트',
    smartDefaultAvatar: '기본 프로필',
    smartPrivate: '비공개',
    smartOldFollowing: '오래된 팔로잉',
    smartNoMemo: '미분류',
    smartUnstable: '불안정',
    smartConfirm: (n) => `추천 ${n}명을 언팔하시겠습니까?`,
    // v5.0: Premium
    premiumFeature: '프리미엄',
    premiumSmartUnfollow: '스마트 언팔은 프리미엄 기능입니다',
    premiumSparkline: '주간 트렌드는 프리미엄 기능입니다',
    // v5.0: Navigation
    dashboard: '대시보드',
    userList: '유저 목록',
    settings: '설정',
  ...
  en: {
    ...
    viewProfile: 'Profile',
    protect: 'Protect',
    protectedUser: (u) => `@${u} protected`,
    unprotectedUser: (u) => `@${u} unprotected`,
    renamedFollowers: (n) => `Username changed (${n})`,
    whitelist: 'Protected',
    ...
    // v5.0: Batch Tag
    batchTag: 'Batch Tag',
    batchTagTitle: 'Apply Tag to Selected',
    batchTagApply: 'Apply',
    batchTagDone: (n, tag) => `Applied "${tag}" tag to ${n} users`,
    // v5.0: Insights
    insightsTitle: 'Notable Changes',
    insightMassUnfollow: (n) => `Mass unfollow detected: ${n} unfollowed you`,
    insightMassFollow: (n) => `New follower surge: ${n} new followers`,
    insightNetGrowth: (n) => `Net growth: ${n > 0 ? '+' : ''}${n}`,
    insightChurnHigh: 'High churn rate. Consider reviewing your content.',
    insightGrowthGood: 'Your followers are growing steadily!',
    insightNoChange: 'No recent changes.',
    weeklyTrend: 'Weekly Trend',
    // v5.0: Smart Unfollow
    smartUnfollowTitle: 'Recommended Unfollows',
    smartUnfollowBtn: 'Smart Unfollow',
    smartUnfollowEmpty: 'No recommendations.',
    smartGhost: 'Ghost',
    smartDefaultAvatar: 'Default avatar',
    smartPrivate: 'Private',
    smartOldFollowing: 'Old following',
    smartNoMemo: 'Uncategorized',
    smartUnstable: 'Unstable',
    smartConfirm: (n) => `Unfollow ${n} recommended users?`,
    // v5.0: Premium
    premiumFeature: 'Premium',
    premiumSmartUnfollow: 'Smart Unfollow is a Premium feature',
    premiumSparkline: 'Weekly Trends is a Premium feature',
    // v5.0: Navigation
    dashboard: 'Dashboard',
    userList: 'Users',
    settings: 'Settings',
